 ...
 */
class modComprobantes extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 50012090;
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'Comprobantes';
        ...
        // (where XXX is value of numeric property 'numero' of module)
        $this->description = "Modulo para gestionar comprobantes de pago ";
        ...
        $this->picto = 'comprobante@comprobantes'; // mypicto@mymodule
        ...
        $this->module_parts = array(
            ...
            'hooks' => array('paiementcard','globalcard')
        ...
        $this->config_page_url = array("admin_comprobante.php@comprobantes");
